...
function updateDeductStockButtonVisual(btn) {
  ...
  if (btn.value === 'true') {
    ...
    btn.className = 'w-full px-3 py-1.5 hud-panel font-bold text-xs transition flex items-center justify-center gap-1.5 bg-cyan-700 hover:bg-cyan-600 text-white border border-cyan-400 shadow shadow-cyan-900/40';
    ...
    btn.className = 'w-full px-3 py-1.5 hud-panel font-bold text-xs transition flex items-center justify-center gap-1.5 bg-[#1e3348] hover:bg-slate-600 text-slate-300 border border-slate-600';
