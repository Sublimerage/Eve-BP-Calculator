    ...
    <div class="job-card lp-job-card ${cardStateClass}"
      ...
      <div class="flex items-center gap-2 p-2 cursor-pointer overflow-x-auto scrollbar-thin" onclick="toggleJobCardCollapse(${job.id})">
        ...
        <div class="flex items-center flex-shrink-0" style="margin-left:20px;">
          ...
          <div class="flex items-baseline justify-end gap-1 flex-shrink-0" style="width:190px;" onclick="event.stopPropagation()">
            ${editingRunsJobIds.has(job.id) ? `
              <span class="text-[9px] uppercase tracking-wide font-bold flex-shrink-0" style="color:var(--text-mute);">Jobs</span>
              ...
              <span class="text-[9px] uppercase tracking-wide font-bold flex-shrink-0" style="color:var(--text-mute);">Runs</span>
            ` : `
              ${(job.jobCount || 1) > 1 ? `<span class="text-[9px] uppercase tracking-wide font-bold flex-shrink-0" style="color:var(--text-mute);">Jobs&times;Runs</span>` : ''}
              ...
              ${(job.jobCount || 1) > 1 ? '' : `<span class="text-xs mono whitespace-nowrap" style="color:var(--text-mute);">runs</span>`}
            `}
